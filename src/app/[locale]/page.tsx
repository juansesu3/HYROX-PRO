...
import TrainerInfo from '@/app/components/coaches/TrainerInfo';
        ...
        return (
            <div className="bg-gray-50 min-h-screen flex flex-col items-center justify-center p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
                    ...
                    {showTrainerInfo && selectedTrainer && (
                        <TrainerInfo
                            trainer={selectedTrainer}
                            onCancel={() => setShowTrainerInfo(false)}
                            onConfirm={() => {
                                setShowTrainerInfo(false);
                                // Aquí ya confirmamos el entrenador → llamamos a la API
                                fetch('/api/select-coach', {
                                    method: 'POST',
                                    headers: { "Content-Type": "application/json" },
